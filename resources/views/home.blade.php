        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-header"><p style="font-size: xx-large">Questions</p>
                        <button class="btn btn-primary" style="background-color: mediumblue" onclick="window.location.href ='{{route('home')}}?sort=result'">Sort By Votes!
                        </button>
                        <button class="btn btn-secondary" onclick="window.location.href ='{{route('home')}}'">Sort By Date!</button>
                                        ...
                                        <div class="card mb-3 ">
                                            ...
                                            <div class="card-footer">
                                                ...
                                                @if (Auth::user())
                                                    ...
                                                    <div class="votes-area" data-postid="{{ $question->id }}"
                                                         data-userid="{{ Auth::user()->id }}">


                                                        <img id="upvote{{$question->id}}" class="voter" data-votetype="up"
                                                             src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRw9lFyg_qYEks4q-6c_Yr4oBG1lPtFtodNGCSeOgf6nJdjL50KSQ"
                                                             width="20" height="20">
                                                        <span>{{ $question->votes_up }}</span>
...
{{--                                                        <span id="resultVote">{{ $question->result }}</span><br>--}}
                                                        <img id="downvote{{$question->id}}" class="voter" data-votetype="down"
                                ...
                                @empty
                                    <a class="btn btn-primary" style="background-color: mediumblue"
                                       href="{{ route('question.create') }}">
    ...
    <script type="text/javascript">
        window.onload = function () {
            ...
            function changeImageUp(postId){
                console.log("inside function"+document.getElementById("upvote"+postId));
                document.getElementById("upvote"+postId).src = "http://i.stack.imgur.com/chwM4.png";
                document.getElementById("downvote"+postId).src = "data:image/jpeg;base64,";
            }
            function changeImageDown(postId){
                document.getElementById("downvote"+postId).src = "http://www.clker.com/cliparts/H/X/b/b/5/e/thumbs-dwn-icon-red-th.svg.med.png";
                document.getElementById("upvote"+postId).src = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRw9lFyg_qYEks4q-6c_Yr4oBG1lPtFtodNGCSeOgf6nJdjL50KSQ";
            };
        };
    </script>
@endsection